"""
Django settings for stockbot_42909 project.
...
ROOT_URLCONF = 'stockbot_42909.urls'
...
WSGI_APPLICATION = 'stockbot_42909.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stockbot_42909 API",
    "DESCRIPTION": "API documentation for stockbot_42909 App",
    "VERSION": "v1",
}
